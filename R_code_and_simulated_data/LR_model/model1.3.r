...
latent <- run.jags('LR_model/model1.3.txt', monitor= c('Se1','Sp1','Se2','Sp2','beta_0','pop1','pop2','var_r','var_h'), 
                   data =list(cum.pop1=cum.pop1, cum.pop2=cum.pop2, herd.id=herd.id, pop.id=pop.id, pop=structure(.Data=popu, .Dim=c(cum.pop2,4)), 
